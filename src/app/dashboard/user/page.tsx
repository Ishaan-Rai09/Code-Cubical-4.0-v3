...
import { User, FileText, Settings, LogOut, CreditCard, BarChart3, Menu, X, Home, ArrowLeft, MessageCircle, Calendar } from 'lucide-react'
...
type TabType = 'analysis' | 'reports' | 'analytics' | 'payments' | 'health-query' | 'booking' | 'settings'
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'settings':
        return (
          <div className="p-8">
            <h2 className="text-2xl font-bold text-luxury-navy mb-6">Patient Settings</h2>
